...
(yas-define-snippets 'scala-mode
		     '(("act" "def act = {\n  loop {\n    react {\n      $0\n    }\n  }\n}" "def act = { ..}" nil nil nil nil nil nil)
		       ...
		       ("cao" "context.actorOf(Props($1), $2) $0\n" "protected" nil nil nil nil nil nil)
		       ("ca" "case ${1:pattern} => $0\n" "case pattern =>" nil nil nil nil nil nil)
		       ("cast" "asInstanceOf[${1:type}] $0" "asInstanceOf[T]" nil nil nil nil nil nil)
		       ("cc" "case class ${1:name}(${2:arg}: ${3:type}) $0\n" "case class T(arg: A)" nil nil nil nil nil nil)
		       ("cl" "class ${1:name} {\n  $0\n}" "class T { .. }" nil nil nil nil nil nil)
		       ("cla" "abstract class ${1:name} {\n  $0\n}\n" "abstract class T { .. }" nil nil nil nil nil nil)
		       ("claa" "abstract class ${1:name}(${2:args}) {\n  $0\n}\n" "abstract class T(args) { .. }" nil nil nil nil nil nil)
		       ...
		       ("defi" "def ${1:name}: ${2:type} = $0\n" "def f = ..." nil nil nil nil nil nil)
		       ("defs" "def ${1:name}: ${2:type} = {\n  $0\n}\n" "def f = ..." nil nil nil nil nil nil)
		       ...
		       ("ov" "override def ${1:name} = $0\n" "override def f =" nil nil nil nil nil nil)
		       ...
		       ("tup" "(${1:element1}, ${2:element2}) $0" "(element1, element2)" nil nil nil nil nil nil)
		       ("v" "val ${1:name} = ${2:obj}\n$0\n" "val name = .." nil nil nil nil nil nil)
